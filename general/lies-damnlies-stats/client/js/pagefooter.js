...
/**
 * @class Handles information displayed in the footer portion of the page.
 * 
 * @example
 * // Create, and that's all there is to it.
 * // Assumes the container already and always exists in the DOM.
 * var pageFooterController = PageFooterController.create({
 *     "containerSelector": "#app-footer",
 * });
 * 
...
// Export
exports.PageFooterController = PageFooterController;
